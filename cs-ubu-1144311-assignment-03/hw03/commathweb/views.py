...
def decto32fp(req):
	if req.method == 'POST':
		...
		return render(req,'exch32.html',{'s':s,'e':e,'f':f,'conb':conb,'d':d})
	else :
		return render(req,'exch32.html')
...
def decto64fp(req):
	if req.method == 'POST':
		...
		return render(req,'exch64.html',{'s':s,'e':e,'f':f,'d':d,'conb':conb})
	else:
		return render(req,'exch64.html')
	#pass
